...
public class MainActivity extends AppCompatActivity implements AddToDoFragment.OnDialogCloseListener, UpdateToDoFragment.OnUpdateDialogCloseListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //This will find the id on the activity_main.xml
        spinner = (Spinner)findViewById(R.id.categories_spinnerOptions);

        //This will make the variable adapter by storing the string and show the drop down of the four categories
    ...
    protected void onStart() {
        ...
        adapter = new ToDoListAdapter(cursor, new ToDoListAdapter.ItemClickListener() {
            ...
            @Override
            public void onItemClick(int pos, String description, String duedate, int id) {
            ...
            // Controls the selection of the category
//            public void onCategorySelected(int id) {
//                ContentValues cv = new ContentValues();
//                cv.put(Contract.TABLE_TODO.COLUMN_CATEGORIES, category);
