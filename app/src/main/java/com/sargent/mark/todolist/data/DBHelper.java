...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        String queryString = "CREATE TABLE " + Contract.TABLE_TODO.TABLE_NAME + " ("+
                ...
                // have the boolean default as false
                Contract.TABLE_TODO.COLUMN_DONE + " INTEGER DEFAULT 0," +
                // Category value is from a set of strings, default is school
                Contract.TABLE_TODO.COLUMN_CATEGORIES + " TEXT NOT NULL DEFAULT 'School' " +
                "); ";
